...
?>
		...
		<div class="updated inline"><p><?php
			if ( file_exists( ABSPATH . '.htaccess' ) )
				printf( __( '<strong>Caution:</strong> We recommend you back up your existing <code>%s</code> and <code>%s</code> files.' ), DEBIAN_FILE, '.htaccess' );
			elseif ( file_exists( ABSPATH . 'web.config' ) )
				printf( __( '<strong>Caution:</strong> We recommend you back up your existing <code>%s</code> and <code>%s</code> files.' ), DEBIAN_FILE, 'web.config' );
			else
				printf( __( '<strong>Caution:</strong> We recommend you back up your existing <code>%s</code> file.' ), DEBIAN_FILE);
		?></p></div>
<?php
	}
?>
